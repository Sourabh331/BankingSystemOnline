...
public class ManageAccountPage extends Base {
	...
	@FindBy(xpath = "//a[@class=\"dropdown-item edit_data\"][@data-id=\"1\"]")
	WebElement edit;// perform click to verify edit

	@FindBy(xpath = "//a[@class=\"dropdown-item delete_data\"][@data-id=\"1\"]")
	...
	public void VerifyPageOption(String searchvalue) {
